...
function(t) {
	...
	function a(t) {
		...
		w = new Array(i + m + 10),
		_[0] = 255 & (248 & e() | m);
		for (var o = 1; o <= m; o++) _[o] = 255 & e();
		m++;
		for (var o = 0; o < 8; o++) $[o] = 0;
		for (n = 1; n <= 2;) m < 8 && (_[m++] = 255 & e(), n++),
		8 == m && c();
		for (var o = 0; i > 0;) m < 8 && (_[m++] = t[o++], i--),
		8 == m && c();
		for (n = 1; n <= 7;) m < 8 && (_[m++] = 0, n++),
		8 == m && c();
		return w
	}
	function l(t) {
		...
		v = 8,
		m++;
		for (var p = 1; p <= 2;) if (m < 8 && (m++, p++), 8 == m && (i = t, !d())) return null;
		for (var o = 0; 0 != e;) if (m < 8 && (w[o] = 255 & (i[y + m] ^ $[m]), o++, e--, m++), 8 == m && (i = t, y = v - 8, !d())) return null;
		for (p = 1; p < 8; p++) {
			if (m < 8) {
	...
	function c() {
		for (var t = 0; t < 8; t++) _[t] ^= b ? $[t] : w[y + t];
		for (var e = u(_), t = 0; t < 8; t++) w[v + t] = e[t] ^ $[t],
		$[t] = _[t];
		y = v,
		v += 8,
		m = 0,
...
function GetEasSid() {
    ...
    if (typeof o != 'string') {
      o = Math.floor(Math.random() * (9999999999999 - 1000000000000) + 1000000000000).toString()
    }
    if (o == undefined || o == null) {
      var t = Math.random().toString().split('.');
      o = t[1]
    }
    if (o) {
      o = o.split('')
...
function encrypt(pwd, salt, vcode) {
	eval("salt = '" + salt + "'")
//	return $.Encryption.getEncryption(pwd, "\u0000\u0000\u0000\u0000\u0007[í\u0015", "!HXR");
	return $.Encryption.getEncryption(pwd, salt, vcode);
}
