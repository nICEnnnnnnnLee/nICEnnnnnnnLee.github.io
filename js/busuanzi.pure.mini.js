...
bszTag = {
    ...
    texts: function(a) {
        this.bszs.map(function(b) {
            ...
            c && (c.innerHTML = a[b])
			var readCountObj = document.getElementById('busuanzi_value_page_pv');
			var readCountObj1 = document.getElementById('busuanzi_value_page_pv1');
			if(readCountObj1 != null){
				readCountObj1.innerHTML = readCountObj.innerHTML;
			}
